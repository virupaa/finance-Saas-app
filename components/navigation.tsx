//Rendered on server but not a server component
"use client";
        ...
        return(
           <Sheet open={isOpen} onOpenChange={setIsOpen}>
                <SheetTrigger>
                    ...
                    hover:text-white border-none focus-visible:ring-offset-0 focus-visible:ring-transparent outline-none text-white
