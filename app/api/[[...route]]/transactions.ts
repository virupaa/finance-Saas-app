...
import { inArray, eq, and, desc, gte, lte, sql } from "drizzle-orm";
...
const app = new Hono()
    ...
    async (c) => {
        ...
        //if nothing is entered by the client then we are gonna show the data of last 30 days
        // take out days from last 30 days using date-fns
